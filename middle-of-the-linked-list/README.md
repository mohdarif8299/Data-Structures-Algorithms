<h2>876. Middle of the Linked List</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given the <code style="user-select: auto;">head</code> of a singly linked list, return <em style="user-select: auto;">the middle node of the linked list</em>.</p>
