<h2>14. Longest Common Prefix</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Write a function to find the longest common prefix string amongst an array of strings.</p>
